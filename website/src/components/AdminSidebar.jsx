...
<<<<<<< Updated upstream
  ...
  return (
    <aside
      className={`bg-white border-r border-gray-200 min-h-full flex-shrink-0 hidden lg:flex flex-col transition-all duration-200 ${
        collapsed ? "w-16" : "w-56"
      }`}
    >
          ...
          >
            ...
            {!collapsed && (
              <>
                ...
                {badge && (
                  <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-400 font-medium">{badge}</span>
                )}
              </>
            )}
          </button>
      ...
      {!collapsed && (
        <div className="p-4 border-t border-gray-100">
          <p className="text-[11px] text-gray-400 leading-relaxed">
            Items marked <span className="font-semibold text-gray-500">Soon</span> are coming in future updates.
          </p>
        </div>
      )}
=======
